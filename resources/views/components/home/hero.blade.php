    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My Name Is Gareth. <br/>
            I am <span class="rounded-md text-amber-600">A Web Developer</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am a developer with 5+ years of experience. <br/>
            I love developing websites and web applications for clients and customers.
            <br>
          </p>
