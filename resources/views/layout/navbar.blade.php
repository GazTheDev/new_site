    ...
    <div class="flex -mx-4 items-center justify-between relative">
      <div class="pr-4 w-60 max-w-full">
        <a href="/" class="w-full flex items-center py-2">
          ...
          />
          <span class=" text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">Gareth Davies</span>
        </a>
      </div>
          ...
          >
            <ul class="block lg:flex lg:items-center">
              ...
              <div class="ml-0 lg:ml-10 xl:ml-16 relative top-1">
                <div class="g-ytsubscribe" data-channelid="UCw6rm4CfwOT9wt6CCH1xJUg" data-layout="default"
